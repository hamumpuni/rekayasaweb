                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="btn-group" role="group">
                                ...
                                {{-- Tombol Edit --}}
                                <a
                                    href="{{ route('admin.layanan.edit', $item->id) }}"
                                ...
                                <form
                                    ...
                                    method="POST"
                                    class="d-inline"
                                    onsubmit="return confirm('Yakin ingin menghapus layanan {{ $item->nama_layanan }}?');"
                                >
                                    @csrf
                                    @method('DELETE')
...
<div
    ...
    tabindex="-1"
    aria-labelledby="modalTambahLayananLabel"
    aria-hidden="true"
>
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('admin.layanan.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea
                            ...
                            rows="4"
                            required
                            placeholder="Tuliskan penjelasan detail mengenai layanan..."
                        ></textarea>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn text-white" style="background-color: #0f1d31;">
                        Simpan Layanan
                    </button>
                </div>
